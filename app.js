...
// const characterActions = ['up', 'top right', 'right', 'down', 'down right', 'jump'];
...
class Character {
    ...
    draw() {
        drawSprite(images.player, this.width * this.frameX, this.height *
            this.frameY, this.width, this.height, this.x, this.y, this.width, this.height);
        //Animate sprites
